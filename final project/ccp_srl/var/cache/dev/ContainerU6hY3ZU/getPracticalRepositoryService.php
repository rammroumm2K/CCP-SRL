 ...
 */
class getPracticalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PracticalRepository' shared autowired service.
     *
     * @return \App\Repository\PracticalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PracticalRepository.php';

        return $container->privates['App\\Repository\\PracticalRepository'] = new \App\Repository\PracticalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
