 ...
 */
class getPracticalLinksRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PracticalLinksRepository' shared autowired service.
     *
     * @return \App\Repository\PracticalLinksRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PracticalLinksRepository.php';

        return $container->privates['App\\Repository\\PracticalLinksRepository'] = new \App\Repository\PracticalLinksRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
